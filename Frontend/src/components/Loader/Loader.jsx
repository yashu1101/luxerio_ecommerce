...
export const Loader = ({height}) => {
  ...
  return (
    <div className='loader-container' style={loaderheight} >
      <svg
        height="108px"
        width="108px"
        viewBox="0 0 128 128"
        ...
        <defs>
          <clipPath id="loader-eyes">
            <circle
              ...
              cy="64"
              cx="64"
              className="loader__eye1"></circle>
            <circle
              transform="rotate(40,64,64) translate(0,-56)"
              r="8"
              cy="64"
              cx="64"
              className="loader__eye2"></circle>
          </clipPath>
          ...
          <g>
            ...
            <g stroke="hsl(16, 100%, 62%)" fill="none">
              <circle
                ...
                cy="64"
                cx="64"
                className="loader__mouth1"></circle>
              <circle
                transform="rotate(0,64,64)"
                r="56"
                cy="64"
                cx="64"
                className="loader__mouth2"></circle>
            </g>
          </g>
